...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::get('/find-job', [HomeController::class, 'show_find_job'])->name('news-feed.show_find_job');
    Route::get('/saved-job', [HomeController::class, 'show_saved_job'])->name('news-feed.show_saved_job');
