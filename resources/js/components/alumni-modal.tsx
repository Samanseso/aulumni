...
export function AlumniModal({ alumni, setViewAlumni }: AlumniModalProps) {
    ...
    const handleTabChange = (tab : string) => {
        switch(tab) {
            case "profile": setSelectedTabController(AlumniController.update_profile.form(alumni.user_id));
            case "personal": setSelectedTabController(AlumniController.update_personal.form(alumni.alumni_id));
            case "academic": setSelectedTabController(AlumniController.update_academic.form(alumni.alumni_id));
            case "contact": setSelectedTabController(AlumniController.update_contact.form(alumni.alumni_id));
                            ...
                            <div>
                                ...
                                <Tabs defaultValue="profile" onValueChange={handleTabChange}>
                                    <TabsList >
                                        ...
                                        <TabsTrigger value="employement">Employment</TabsTrigger>
                                    </TabsList>
