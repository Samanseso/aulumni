import { BadgeDollarSign, BriefcaseBusiness, Building2, Link as LinkIcon, Sparkles } from 'lucide-react';
        ...
        >
            <Card className="overflow-hidden border-slate-200 shadow-sm">
                ...
                <CardContent className="space-y-3 p-5">
                    ...
                    <InfoRow icon={<Sparkles className="size-4" />} label="Work type" value={alumni.employment_details?.current_work_type} />
                    <InfoRow icon={<BadgeDollarSign className="size-4" />} label="Monthly income" value={alumni.employment_details?.current_work_monthly_income} />
                    <InfoRow
